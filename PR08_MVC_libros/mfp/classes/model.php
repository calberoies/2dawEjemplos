...
abstract class model {
	...
	static $labels=[]; // Etiquetas de los atributos
	...
	public function __get($param){
		...
		elseif(method_exists($this,'get'.$param))
			return call_user_func([$this,'get'.$param]);
		else {
	...
	static public function findAll($filter='',$order='',$opts=[]){
